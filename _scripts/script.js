...
$('section.plano-principal').waypoint(function (direcao) {
    if (direcao == 'down') {
        ...
        $('div.planos:eq(1)').addClass('animate__animated animate__fadeInLeft animate_slow')
        $('div.planos:eq(2)').addClass('animate__animated animate__fadeInLeft animate_slower')

    } else {
        $('div.planos:eq(0)').removeClass('animate__animated animate__fadeInLeft animate_slower')
        $('div.planos:eq(1)').removeClass('animate__animated animate__fadeInLeft animate_slow')
        $('div.planos:eq(2)').removeClass('animate__animated animate__fadeInLeft animate_slower')
